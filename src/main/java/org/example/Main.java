...
public class Main {
    static String[] arrayOfTopic =  {"Installation confirmation", "installer not available", "Cancel Installation Request","Task finished"}; // Creating an array that can hold 3 strings
     static String[] arrayOfMsg = {"The Installation has been confirmed","We are sorry, but the Installation Request has been canceled due to logistical restrictions beyond our store's control","Thank you for using our company"}; // Creating an array that can hold 3 strings
    ...
    public static void scheduleAppointmentMenu(){
        ...
        if (choice == 1) {
            ...
            gmailSend.sendEmail(installer.getGmail(), arrayOfTopic[2],arrayOfMsg[1]);
            ...
            if(yesOrNo()==1){
                ...
                gmailSend.sendEmail(installer.getGmail(),arrayOfTopic[3],arrayOfMsg[2]);
                Installer.setCompletionDate("--");
                scheduleAppointmentMenu();
            }
            else {
    ...
    public static void sendEmailNewDayHour() {
        ...
        if (choice == 1) {
            ...
            gmailSend.sendEmail(installer.getGmail(), arrayOfTopic[1],msg1);
    ...
    public static void approvalOfTheRequestFromAdminOrInstaller(long idInstallerRequest){
        ...
        if(yesOrNo()==1){
            ...
            installer.addThisInstallerRequest();
            gmailSend.sendEmail(installer.getGmail(),arrayOfTopic[0],arrayOfMsg[0]);
        }
        else {
            scheduleAppointmentMenu();
        }
