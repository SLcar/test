Feature: Manage the order page
  ...
  Scenario: customer request order with all info
    ...
    When customer enter exist productsId to order "9"
  ...
  Scenario: customer can't edit non exist productId in order
    ...
    #########################################################################
  Scenario: Admin can edit customer orders status to shipped
  ...
  Scenario: Admin can edit customer orders status to delivered
    Given admin choose view customer order
    And   The Customer Id is "12345678"
    And   The Customer Name is "Saja"
    When  enter exist order "4928437108"
...
############################# customer cancel order ######################
  ...
  Scenario: customer can show  Delivered order
    Given The Customer Name is "Saja"
    And The Customer Id is "12345678"
    Then  customer view The "delivered" orders

  Scenario: Admin can show  Delivered order
    Then  Admin view "delivered" orders